...
import (
	...
	ethtest "github.com/Sojahub/sojanode/x/ethbridge/test"
	...
	balances := []banktypes.Balance{
		{
			...
			Coins: sdk.Coins{
				...
				sdk.NewCoin("fury", nativeAssetBalance),
			},
		},
	}
	...
	tc := TestCase{
		...
		Messages: []sdk.Msg{
			&clptypes.MsgCreatePool{
				...
				NativeAssetAmount:   sdk.NewUintFromString("1000000000000000000000000000"), // 1000,000,000fury
			...
			&margintypes.MsgOpen{
				...
				CollateralAsset:  "fury",
				CollateralAmount: sdk.NewUintFromString("500000000000000000000000"), // 500,000fury
				BorrowAsset:      "atom",
				Position:         margintypes.Position_LONG,
...
func endBlock(t *testing.T, app *sojaapp.SojahubApp, ctx sdk.Context, height int64) {
...
func getResults(t *testing.T, app *sojaapp.SojahubApp, ctx sdk.Context, tc TestCase) TestResults {
