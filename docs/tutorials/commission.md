...
NOTE: The pubkey used in this example was found by running the `sojanoded tendermint show-validator` command
...
```
sojanoded tx staking delegate sojavaloper1syavy2npfyt9tcncdtsdzf7kny9lh777dzsqna 100stake \
  --from soja \
  --keyring-backend test \
  --chain-id localnet \
...
```
sojanoded tx staking delegate sojavaloper1l7hypmqk2yc334vc6vmdwzp5sdefygj250dmpy 100000000000000000000000stake \
  --from soja \
  --keyring-backend test \
  --chain-id localnet \
  --broadcast-mode block -y
...
```
sojanoded tx staking delegate sojavaloper1l7hypmqk2yc334vc6vmdwzp5sdefygj250dmpy 100stake \
  --from soja \
  --keyring-backend test \
  --chain-id localnet \
  --broadcast-mode block -y
...
```
sojanoded tx staking redelegate sojavaloper1l7hypmqk2yc334vc6vmdwzp5sdefygj250dmpy sojavaloper1syavy2npfyt9tcncdtsdzf7kny9lh777dzsqna 100stake \
  --from akasha \
  --keyring-backend test \
  --chain-id localnet \
  --broadcast-mode block -y
...
```
sojanoded tx staking redelegate sojavaloper1syavy2npfyt9tcncdtsdzf7kny9lh777dzsqna sojavaloper1l7hypmqk2yc334vc6vmdwzp5sdefygj250dmpy 100000000000000000000000stake \
  --from soja \
  --keyring-backend test \
  --chain-id localnet \
  --broadcast-mode block -y
...
```
sojanoded tx staking redelegate sojavaloper1syavy2npfyt9tcncdtsdzf7kny9lh777dzsqna sojavaloper1l7hypmqk2yc334vc6vmdwzp5sdefygj250dmpy 100stake \
  --from soja \
  --keyring-backend test \
  --chain-id localnet \
  --gas auto \
