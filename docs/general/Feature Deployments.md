# Sojanode Feature Deployments

## Push

Each feature branch will deploy a single Sojanode node to a testnet k8s cluster on AWS, with each push.
...
```
aws eks --region us-west-2 update-kubeconfig --name sojahub-aws-feature-testnets
```
...
sojanoded     LoadBalancer   172.20.199.3   a5ffd81a54d214554aa2b2dd91e80030-2091375959.us-west-2.elb.amazonaws.com   1317:30336/TCP   20h
sojanoded   LoadBalancer   172.20.99.92   a63326ebdec3747f1b1d40fc7efaa5bb-299351102.us-west-2.elb.amazonaws.com    26656-26657:30840-30841/TCP   20h
```
