# **Sojahub Liquidity Pools Architecture**

## Changelog
-First Draft: Austin Haines &amp; Charlie Wolf (Barefoot Coders)
 Prepared For: Jazear Brooks, Sojahub  September 21, 2020
...
## Context
Outlined below are the starting points of an architecture that will allow Sojahub to implement an MVP version of liquidity pools similar to Sushiswap.
...
![](images/SojahubCLPArchitecture/SojahubMessages.png)
...
![](images/SojahubCLPArchitecture/SojahubEvent.png)
...
![](images/SojahubCLPArchitecture/SojahubAppStructure.png)
...
![](images/SojahubCLPArchitecture/SojahubStructs.png)
...
![](images/SojahubCLPArchitecture/SojahubDecommissionFlow.png)
...
```
![](images/SojahubCLPArchitecture/SojahubAddLiquidity.png)
...
```
![](images/SojahubCLPArchitecture/SojahubRemoveLiquidity.png)
...
```
![](images/SojahubCLPArchitecture/SojahubSwap.png)

![](images/SojahubCLPArchitecture/SojahubCreateSwapFlow.png)

**Swap Queue:** This feature is part of Thorchain's CLP model and will order swap execution by fee and slip size to ensure maximum fee collection and to prevent low-value trades. This is currently slated as a future goal for Sojahub.
