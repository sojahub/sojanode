...
```shell
sojatest verify add --from did:fury:s1syavy2npfyt9tcncdtsdzf7kny9lh777exhphm --height=43516 --external-asset=ceth --nativeAmount=96176925423929435353999282 --externalAmount=488436982990 --node tcp://localhost:26657
```
...
Command
```shell
sojatest verify remove --from did:fury:s1syavy2npfyt9tcncdtsdzf7kny9lh777exhphm --units 1000000000000000000 --height=33068 --external-asset=ceth --node tcp://localhost:26657
```
...
```shell
sojatest verify close --from did:fury:s1syavy2npfyt9tcncdtsdzf7kny9lh777exhphm --height=72990 --id=4 --node tcp://localhost:26657
```
Output
```shell
verifying close...
