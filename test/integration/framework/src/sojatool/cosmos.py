...
LegacyBalance = List[List[Union[int, str]]]  # e.g. [[3, "fury"], [2, "ibc/xxxxx"]]
...
# class/module.)
# Source: https://sojahub.slack.com/archives/C01T05LPFEG/p1632822677353400?thread_ts=1632735716.332000&cid=C01T05LPFEG
...
def transfer(cmd, channel, address, amount, from_addr, chain_id, node, gas_prices, gas, packet_timeout_timestamp):
    ...
    # did:fury:s19q2swhcxkxlc6va3pz5jz42jfsfv2ly4kuu8y0
    ...
    # channel = "channel-66"
    # address = "did:fury:s19q2swhcxkxlc6va3pz5jz42jfsfv2ly4kuu8y0
