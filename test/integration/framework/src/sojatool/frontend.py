from sojatool import command, project
from sojatool.common import *

GIT_REPO_PROXIES = "git@github.com:Sojahub/proxies.git"
GITHUB_REPO_UI = "https://github.com/Sojahub/sojahub-ui.git"
...
def run_local_ui(cmd: command.Command):
    ...
    ui_repo_dir = os.path.join(working_dir, "sojahub-ui")
