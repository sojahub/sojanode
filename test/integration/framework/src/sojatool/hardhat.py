import json
import web3
from sojatool import eth, command
from sojatool.command import Command, ExecResult, buildcmd
...
class ScriptRunner:
    ...
    # TODO This is called mostly from sojatool and it's one line, convert to web3 call
    def update_validator_power(self, cosmos_bridge_addr, evm_validator_addresses, sojanode_witnesses):
        npx_env = {
            "COSMOSBRIDGE": cosmos_bridge_addr,
            "POWERS": ",".join(str(x["power"]) for x in sojanode_witnesses),
