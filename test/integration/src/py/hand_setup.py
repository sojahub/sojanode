...
from test_utilities import get_required_env_var, SojahubcliCredentials, get_optional_env_var, \
...
def build_request() -> (EthereumToSojahubTransferRequest, SojahubcliCredentials):
...
try:
    test_utilities.get_shell_output(f"sojanoded keys delete user1 --home /home/vagrant/.sojanoded --keyring-backend test -o json")
except:
...
test_utilities.get_sojahub_addr_balance(request.sojahub_address, request.sojanoded_node, "ceth")
