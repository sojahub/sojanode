...
class IntegrationTestContext:
    ...
    @property
    def sojanoded_node(self):
        return self.get_optional_var("SOJANODE", None)

    @property
    def sojanode_base_dir(self):
        return self.get_required_var("BASEDIR")

    @property
    def smart_contracts_dir(self):
        return self.get_optional_var("SMART_CONTRACTS_DIR", os.path.join(self.sojanode_base_dir, "smart-contracts"))
    ...
    def is_ropsten_testnet(self):
        ...
        return bool(self.sojanoded_node)
    ...
    def sojahub_fees(self):
        ...
        return f"{self.sojahub_fees_int}fury"
    ...
    def ganache_keys_file(self):
        return self.get_optional_var("GANACHE_KEYS_FILE",
            os.path.join(self.sojanode_base_dir, "test/integration/vagrant/data/ganachekeys.json"))
    ...
    def fury_source_integrationtest_env_transfer_request(self, basic_transfer_request):
        ...
        result.sojahub_address = self.fury_source
    ...
    def basic_transfer_request(self):
        ...
        return test_utilities.EthereumToSojahubTransferRequest(
            ...
            sojanoded_node=self.sojanoded_node,
            manual_block_advance=self.is_ganache,
            chain_id=self.chain_id,
            sojahub_fees=self.sojahub_fees,
