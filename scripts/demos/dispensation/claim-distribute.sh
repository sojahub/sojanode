...
sleep 8
sojanoded tx dispensation create ValidatorSubsidy output.json soja1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd --gas 200064128 --from soja1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd --keyring-backend test --fees 100000fury --yes --chain-id sojahub-devnet-042 --node tcp://rpc-devnet-042.sojahub.finance:80
