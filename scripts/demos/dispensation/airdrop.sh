...
sojanoded tx dispensation create ValidatorSubsidy output.json soja1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd --from soja1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd --yes --fees 150000fury --chain-id=localnet --keyring-backend=test
sojanoded tx dispensation run 29_soja1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd ValidatorSubsidy--from soja1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd --yes --fees 150000fury --chain-id=localnet --keyring-backend=test
sleep 8
...
sojanoded tx dispensation run 25_soja1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd ValidatorSubsidy --from soja1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd --yes --gas auto --gas-adjustment=1.5 --gas-prices 1.0fury --chain-id=localnet --keyring-backend=test
