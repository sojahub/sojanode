...
sojanoded q tokenregistry generate \
	...
	-o json | jq > $SOJAHUB_ID/cxft.json
...
sojanoded q tokenregistry generate \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true -o json | jq > $SOJAHUB_ID/cuos.json
...
sojanoded q tokenregistry generate \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true -o json | jq > $SOJAHUB_ID/cnewo.json
...
sojanoded q tokenregistry generate \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true -o json | jq > $SOJAHUB_ID/cosqth.json
...
sojanoded q tokenregistry generate \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true -o json | jq > $SOJAHUB_ID/cgala.json
...
sojanoded q tokenregistry generate \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true -o json | jq > $SOJAHUB_ID/cpush.json
...
sojanoded q tokenregistry generate \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true -o json | jq > $SOJAHUB_ID/cmc.json
...
sojanoded q tokenregistry generate \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true -o json | jq > $SOJAHUB_ID/cinj.json
...
sojanoded q tokenregistry generate \
	...
	--token_permission_clp=true \
	--token_permission_ibc_export=true \
	--token_permission_ibc_import=true -o json | jq > $SOJAHUB_ID/ccudos.json
