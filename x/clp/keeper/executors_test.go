...
func TestKeeper_CreatePool_Error(t *testing.T) {
	...
	_ = sojaapp.AddCoinsToAccount(types.ModuleName, app.BankKeeper, ctx, signer, sdk.NewCoins(externalCoin, nativeCoin))
...
func TestKeeper_CreatePool_And_AddLiquidity_RemoveLiquidity(t *testing.T) {
	...
	assert.Equal(t, lp.LiquidityProviderAddress, "did:fury:s15ky9du8a2wlstz6fpx3p4mqpjyrm5cgq24l6ma")
...
func TestKeeper_CreateLiquidityProvider(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Equal(t, lp.LiquidityProviderAddress, "did:fury:s1azpar20ck9lpys89r8x7zc8yu0qzgvtpgpurs6")
}
...
func TestKeeper_FinalizeSwap(t *testing.T) {
	...
	_ = sojaapp.AddCoinsToAccount(types.ModuleName, app.BankKeeper, ctx, signer, sdk.NewCoins(externalCoin1, nativeCoin))
	_ = sojaapp.AddCoinsToAccount(types.ModuleName, app.BankKeeper, ctx, signer, sdk.NewCoins(externalCoin2, nativeCoin))
