...
func TestKeeper_CreatePool_And_AddLiquidity_RemoveLiquidity(t *testing.T) {
	...
	assert.Equal(t, lp.LiquidityProviderAddress, "did:fury:s15ky9du8a2wlstz6fpx3p4mqpjyrm5cgqhns3lt")
...
func TestKeeper_CreateLiquidityProvider(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Equal(t, lp.LiquidityProviderAddress, "did:fury:s1azpar20ck9lpys89r8x7zc8yu0qzgvtp48ng5v")
}
