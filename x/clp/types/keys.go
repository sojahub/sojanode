...
// Example : eth_did:fury:s1azpar20ck9lpys89r8x7zc8yu0qzgvtpgpurs6 and converted into bytes after adding a prefix
...
func GetDefaultLiquidityProtectionParams() *LiquidityProtectionParams {
	return &LiquidityProtectionParams{
		MaxFuryLiquidityThreshold:      sdk.NewUint(1000000000000),
