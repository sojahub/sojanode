...
import (
	"encoding/json"
	"github.com/Sojahub/sojanode/x/ethbridge/utils"
	"io/ioutil"
	"path/filepath"
	"regexp"
	"strconv"
...
// GetCmdUpdateCethReceiverAccount is the CLI command to update the sojahub account that receives the ceth proceeds
