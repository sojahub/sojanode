...
// source: sojanode/tokenregistry/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryEntriesResponse)(nil), "sojanode.tokenregistry.v1.QueryEntriesResponse")
	proto.RegisterType((*QueryEntriesRequest)(nil), "sojanode.tokenregistry.v1.QueryEntriesRequest")
}

func init() {
	proto.RegisterFile("sojanode/tokenregistry/v1/query.proto", fileDescriptor_c311bc06126a6f47)
}
...
var fileDescriptor_c311bc06126a6f47 = []byte{
	...
	,
	...
	0x49, 0x7a, 0xc9, 0xf9, 0xb9, 0xfa, 0xc1, 0x30, 0xc3, 0x60, 0x01, 0x5d, 0x81, 0x66, 0x2c, 0x38,
	0x9c, 0x93, 0xd8, 0xc0, 0x01, 0x6d, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x06, 0x74, 0x5a, 0x30,
	0x04, 0x02, 0x00, 0x00,
}
...
func (c *queryClient) Entries(ctx context.Context, in *QueryEntriesRequest, opts ...grpc.CallOption) (*QueryEntriesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sojanode.tokenregistry.v1.Query/Entries", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Entries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sojanode.tokenregistry.v1.Query/Entries",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "sojanode.tokenregistry.v1.Query",
	...
	Metadata: "sojanode/tokenregistry/v1/query.proto",
}
