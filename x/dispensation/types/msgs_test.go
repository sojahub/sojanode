...
func TestMsgCreateDistribution_ValidateBasic_Order(t *testing.T) {
	...
	coin := []sdk.Coin{sdk.NewCoin("fury", sdk.NewInt(1000000)), sdk.NewCoin("cusdt", sdk.NewInt(1000000))}
...
func TestMsgCreateDistribution_ValidateBasic_WrongAddress(t *testing.T) {
	...
	outputList = append(outputList, banktypes.NewOutput(invalidAddress, sdk.NewCoins(sdk.NewCoin("fury", sdk.NewInt(1000000)))))
	msg := types.MsgCreateDistribution{
		Distributor:      distributor.String(),
		DistributionType: types.DistributionType_DISTRIBUTION_TYPE_AIRDROP,
		Output:           outputList,
	...
	outputList = append(outputList, banktypes.NewOutput(invalidAddress2, sdk.NewCoins(sdk.NewCoin("fury", sdk.NewInt(1000000)))))
	msg = types.MsgCreateDistribution{
		Distributor:      distributor.String(),
		DistributionType: types.DistributionType_DISTRIBUTION_TYPE_AIRDROP,
		Output:           outputList,
...
func TestMsgCreateDistribution_ValidateBasic_NonFury(t *testing.T) {
...
func TestMsgCreateDistribution_ValidateBasic_MultipleCoins(t *testing.T) {
	...
	authorizedRunner := sdk.AccAddress("addr2_______________")
	outputlist = append(outputlist, banktypes.NewOutput(sdk.AccAddress(ed25519.GenPrivKey().PubKey().Address()),
		sdk.NewCoins(sdk.NewCoin("fury", sdk.NewInt(10)), sdk.NewCoin("dash", sdk.NewInt(100)))))
	msg := types.MsgCreateDistribution{
		Distributor:      distributor.String(),
		DistributionType: types.DistributionType_DISTRIBUTION_TYPE_AIRDROP,
		Output:           outputlist,
