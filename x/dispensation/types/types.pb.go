...
// source: sojanode/dispensation/v1/types.proto
...
type DistributionRecord struct {
	DistributionStatus          DistributionStatus                       `protobuf:"varint,1,opt,name=distribution_status,json=distributionStatus,proto3,enum=sojanode.dispensation.v1.DistributionStatus" json:"distribution_status,omitempty"`
	DistributionType            DistributionType                         `protobuf:"varint,2,opt,name=distribution_type,json=distributionType,proto3,enum=sojanode.dispensation.v1.DistributionType" json:"distribution_type,omitempty"`
...
type Distribution struct {
	DistributionType DistributionType `protobuf:"varint,1,opt,name=distribution_type,json=distributionType,proto3,enum=sojanode.dispensation.v1.DistributionType" json:"distribution_type,omitempty"`
...
func (m *Distribution) GetRunner() string {
	if m != nil {
		return m.Runner
	}
	return ""
...
type UserClaim struct {
	...
	UserClaimType DistributionType                          `protobuf:"varint,2,opt,name=user_claim_type,json=userClaimType,proto3,enum=sojanode.dispensation.v1.DistributionType" json:"user_claim_type,omitempty"`
	UserClaimTime *github_com_gogo_protobuf_types.Timestamp `protobuf:"bytes,3,opt,name=user_claim_time,json=userClaimTime,proto3,customtype=github.com/gogo/protobuf/types.Timestamp" json:"user_claim_time,omitempty"`
}
...
type MintController struct {
	TotalCounter types.Coin `protobuf:"bytes,1,opt,name=total_counter,json=totalCounter,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"total_counter" yaml:"coins"`
}

func (m *MintController) Reset()         { *m = MintController{} }
func (m *MintController) String() string { return proto.CompactTextString(m) }
func (*MintController) ProtoMessage()    {}
func (*MintController) Descriptor() ([]byte, []int) {
	return fileDescriptor_bfdf912039cd8799, []int{7}
}
func (m *MintController) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MintController) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MintController.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MintController) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MintController.Merge(m, src)
}
func (m *MintController) XXX_Size() int {
	return m.Size()
}
func (m *MintController) XXX_DiscardUnknown() {
	xxx_messageInfo_MintController.DiscardUnknown(m)
}

var xxx_messageInfo_MintController proto.InternalMessageInfo

func (m *MintController) GetTotalCounter() types.Coin {
	if m != nil {
		return m.TotalCounter
	}
	return types.Coin{}
}

func init() {
	proto.RegisterEnum("sojanode.dispensation.v1.DistributionType", DistributionType_name, DistributionType_value)
	proto.RegisterEnum("sojanode.dispensation.v1.DistributionStatus", DistributionStatus_name, DistributionStatus_value)
	proto.RegisterType((*GenesisState)(nil), "sojanode.dispensation.v1.GenesisState")
	proto.RegisterType((*DistributionRecord)(nil), "sojanode.dispensation.v1.DistributionRecord")
	proto.RegisterType((*DistributionRecords)(nil), "sojanode.dispensation.v1.DistributionRecords")
	proto.RegisterType((*Distributions)(nil), "sojanode.dispensation.v1.Distributions")
	proto.RegisterType((*Distribution)(nil), "sojanode.dispensation.v1.Distribution")
	proto.RegisterType((*UserClaim)(nil), "sojanode.dispensation.v1.UserClaim")
	proto.RegisterType((*UserClaims)(nil), "sojanode.dispensation.v1.UserClaims")
	proto.RegisterType((*MintController)(nil), "sojanode.dispensation.v1.MintController")
}

func init() {
	proto.RegisterFile("sojanode/dispensation/v1/types.proto", fileDescriptor_bfdf912039cd8799)
}
...
var fileDescriptor_bfdf912039cd8799 = []byte{
	...
	,
}
...
func (m *Distribution) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Runner) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.Runner)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.DistributionName) > 0 {
...
func (m *UserClaim) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.UserClaimTime != nil {
		{
			size := m.UserClaimTime.Size()
			i -= size
			if _, err := m.UserClaimTime.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
			i = encodeVarintTypes(dAtA, i, uint64(size))
		}
...
func (m *MintController) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MintController) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MintController) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	{
		size, err := m.TotalCounter.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *MintController) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = m.TotalCounter.Size()
	n += 1 + l + sovTypes(uint64(l))
	return n
}
...
func (m *UserClaim) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			var v github_com_gogo_protobuf_types.Timestamp
			m.UserClaimTime = &v
			if err := m.UserClaimTime.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *MintController) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MintController: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MintController: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalCounter", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.TotalCounter.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
