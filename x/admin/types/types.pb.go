...
// source: sojanode/admin/v1/types.proto
...
type AdminAccount struct {
	AdminType    AdminType `protobuf:"varint,1,opt,name=admin_type,json=adminType,proto3,enum=sojanode.admin.v1.AdminType" json:"admin_type,omitempty"`
...
func init() {
	proto.RegisterEnum("sojanode.admin.v1.AdminType", AdminType_name, AdminType_value)
	proto.RegisterType((*GenesisState)(nil), "sojanode.admin.v1.GenesisState")
	proto.RegisterType((*AdminAccount)(nil), "sojanode.admin.v1.AdminAccount")
	proto.RegisterType((*Params)(nil), "sojanode.admin.v1.Params")
}

func init() { proto.RegisterFile("sojanode/admin/v1/types.proto", fileDescriptor_97192799444a7295) }
