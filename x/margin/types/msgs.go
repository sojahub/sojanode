...
var (
	...
	_ sdk.Msg = &MsgUpdateFuryCollateral{}
	...
	_ legacytx.LegacyMsg = &MsgUpdateFuryCollateral{}
...
func (m MsgUpdateFuryCollateral) GetSigners() []sdk.AccAddress {
	signer, err := sdk.AccAddressFromBech32(m.Signer)
	if err != nil {
		panic(err)
	}
...
func (m MsgUpdateFuryCollateral) GetSignBytes() []byte {
	return sdk.MustSortJSON(ModuleCdc.MustMarshalJSON(&m))
}

func (m MsgUpdateFuryCollateral) Route() string {
	return RouterKey
}

func (m MsgUpdateFuryCollateral) Type() string {
	return "update_fury_collateral"
}

func (m MsgUpdateFuryCollateral) ValidateBasic() error {
	if len(m.Signer) == 0 {
		return sdkerrors.Wrap(sdkerrors.ErrInvalidAddress, m.Signer)
	}
