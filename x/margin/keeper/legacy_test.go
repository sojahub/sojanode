...
func TestKeeper_NewLegacyHandler(t *testing.T) {
	...
	marginKeeper.WhitelistAddress(ctx, "soja1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd")
	...
	var (
		msgOpen       sdk.Msg = &types.MsgOpen{Signer: "soja1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd"}
