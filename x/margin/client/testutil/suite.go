...
func (s *IntegrationTestSuite) SetupSuite() {
	...
	s.address = "did:fury:s1syavy2npfyt9tcncdtsdzf7kny9lh777p07psd"
...
func (s *IntegrationTestSuite) TestB_OpenLongMTP() {
	...
	collateralAmount := sdk.NewUintFromString("10000000000000000000000") // 10000 fury
	borrowAsset := "cusdt"
	position := "long"
	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedPool: clptypes.Pool{
				...
				NativeAssetBalance:            sdk.NewUintFromString("1540459183129248235861408"), // 1560459 fury
