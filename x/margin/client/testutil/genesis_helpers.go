	...
	gs := &tokenregistrytypes.GenesisState{
		Registry: &tokenregistrytypes.Registry{
			Entries: []*tokenregistrytypes.RegistryEntry{
				...
				{Denom: "fury", BaseDenom: "fury", Decimals: 18, Permissions: []tokenregistrytypes.Permission{tokenregistrytypes.Permission_CLP, tokenregistrytypes.Permission_IBCEXPORT, tokenregistrytypes.Permission_IBCIMPORT}},
			},
		},
	}
	bz, err := cfg.Codec.MarshalJSON(gs)
