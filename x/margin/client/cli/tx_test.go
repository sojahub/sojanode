...
import (
	...
	"github.com/Sojahub/sojanode/x/margin/client/cli"
...
func (s *IntegrationTestSuite) SetupSuite() {
	...
	// 	db := dbm.NewMemDB()
	// 	return sojaapp.NewSojaApp(log.NewTMLogger(log.NewSyncWriter(os.Stdout)), db, nil, true, map[int64]bool{}, val.Dir, 0, encConfig, sojaapp.EmptyAppOptions{})
	// }
