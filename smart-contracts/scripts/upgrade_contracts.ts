...
import {setupRopstenDeployment, setupSojahubMainnetDeployment} from "../src/hardhatFunctions";
...
// DEPLOYMENT_NAME="sojahub-testnet-042-ibc"
...
async function main() {
    ...
    const factories = await container.resolve(SojahubContractFactories) as SojahubContractFactories
