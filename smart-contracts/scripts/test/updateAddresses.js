...
// directly)
//
// For example, to get the sojahub version:
// 
//   node scripts/test/updateAddresses.js $BASEDIR/ui/core/src/tokenwhitelist.sandpit.json $BASEDIR/ui/core/src/assets.ethereum.ropsten.json | jq .sojahub
//
//
...
const sojahubAssets = assets.map(t => {
    return {
        ...t,
