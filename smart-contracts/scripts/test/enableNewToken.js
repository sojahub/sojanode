...
module.exports = async (cb) => {
    ...
    const argv = sojahubUtilities.processArgs(this, {
        ...
        ...sojahubUtilities.symbolYargOption,
        ...sojahubUtilities.amountYargOption,
        'limit_amount': {
            describe: 'an amount',
            demandOption: true
        },
    ...
    const newTokenBuilder = await contractUtilites.buildBaseContract(this, argv, logging, "SojahubTestToken");
