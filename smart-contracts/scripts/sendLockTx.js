module.exports = async (cb) => {
  ...
  console.log("Expected usage: \nBRIDGEBANK_ADDRESS='0x9e8bd20374898f61b4e5bd32b880b7fe198e44a1' truffle exec scripts/sendLockTx.js --network ropsten did:fury:s1nx650s8q9w28f2g3t9ztxyg48ugldptuwzpace eth 100\n");
  /*******************************************
   *** Constants
   ******************************************/
