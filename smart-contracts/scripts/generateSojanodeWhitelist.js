 ...
 *
 * Finally, run
 * $ npx hardhat run scripts/generateSojanodeWhitelist.js --network mainnet
 */
...
const sojanodeDS = require("../data/ds_sojanode_whitelist.json");
...
async function main() {
  ...
  for (let i = 0; i < addressList.length; i++) {
    try {
      ...
      const obj = _.cloneDeep(sojanodeDS);
