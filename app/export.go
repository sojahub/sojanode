...
// file.
func (app *SojahubApp) ExportAppStateAndValidators(
...
func (app *SojahubApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
...
func ExportAppState(name string, app *SojahubApp, ctx sdk.Context) {
