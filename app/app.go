...
import (
	...
	sojahubAnte "github.com/Sojahub/sojanode/app/ante"
	"github.com/Sojahub/sojanode/x/admin"
	adminkeeper "github.com/Sojahub/sojanode/x/admin/keeper"
	admintypes "github.com/Sojahub/sojanode/x/admin/types"
	"github.com/Sojahub/sojanode/x/clp"
	clpkeeper "github.com/Sojahub/sojanode/x/clp/keeper"
	clptypes "github.com/Sojahub/sojanode/x/clp/types"
	"github.com/Sojahub/sojanode/x/dispensation"
	dispkeeper "github.com/Sojahub/sojanode/x/dispensation/keeper"
	disptypes "github.com/Sojahub/sojanode/x/dispensation/types"
	"github.com/Sojahub/sojanode/x/ethbridge"
	ethbridgekeeper "github.com/Sojahub/sojanode/x/ethbridge/keeper"
	ethbridgetypes "github.com/Sojahub/sojanode/x/ethbridge/types"
	ibctransferoverride "github.com/Sojahub/sojanode/x/ibctransfer"
	sctransfertypes "github.com/Sojahub/sojanode/x/ibctransfer/types"
	"github.com/Sojahub/sojanode/x/margin"
	...
	oraclekeeper "github.com/Sojahub/sojanode/x/oracle/keeper"
	oracletypes "github.com/Sojahub/sojanode/x/oracle/types"
	"github.com/Sojahub/sojanode/x/tokenregistry"
	tokenregistrykeeper "github.com/Sojahub/sojanode/x/tokenregistry/keeper"
...
const appName = "sojanode"

var (
	DefaultNodeHome = os.ExpandEnv("$HOME/.sojanoded")
...
var (
	_ simapp.App              = (*SojahubApp)(nil)
	_ servertypes.Application = (*SojahubApp)(nil)
)

type SojahubApp struct {
	*baseapp.BaseApp
...
func NewSojaApp(
	...
	return NewSojaAppWithBlacklist(logger, db, traceStore, loadLatest, skipUpgradeHeights, homePath, invCheckPeriod, encodingConfig, appOpts, []sdk.AccAddress{}, baseAppOptions...)
}

func NewSojaAppWithBlacklist(
	logger log.Logger, db dbm.DB, traceStore io.Writer, loadLatest bool, skipUpgradeHeights map[int64]bool,
	homePath string, invCheckPeriod uint, encodingConfig simappparams.EncodingConfig,
	...
	*/
	...
	anteHandler, err := sojahubAnte.NewAnteHandler(
		sojahubAnte.HandlerOptions{
...
func (app *SojahubApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *SojahubApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

func (app *SojahubApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

func (app *SojahubApp) LegacyAmino() *codec.LegacyAmino { //nolint
...
func (app *SojahubApp) AppCodec() codec.Codec {
	return app.appCodec
}
...
func (app *SojahubApp) GetSubspace(moduleName string) paramstypes.Subspace {
	subspace, _ := app.ParamsKeeper.GetSubspace(moduleName)
	return subspace
}

func (app *SojahubApp) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *SojahubApp) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *SojahubApp) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
	return app.memKeys[storeKey]
}

// LoadHeight loads a particular height
func (app *SojahubApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *SojahubApp) ModuleAccountAddrs() map[string]bool {
...
func (app *SojahubApp) SimulationManager() *module.SimulationManager {
	return app.sm
}
...
// API server.
func (app *SojahubApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *SojahubApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *SojahubApp) RegisterTendermintService(clientCtx client.Context) {
