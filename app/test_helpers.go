...
func setup(withGenesis bool, invCheckPeriod uint, blacklist []sdk.AccAddress) (*SojahubApp, GenesisState) {
	db := dbm.NewMemDB()
	encCdc := MakeTestEncodingConfig()
	app := NewSojaAppWithBlacklist(log.NewNopLogger(), db, nil, true, map[int64]bool{}, DefaultNodeHome, invCheckPeriod, encCdc, EmptyAppOptions{}, blacklist)
	if withGenesis {
...
func Setup(isCheckTx bool) *SojahubApp {
	return SetupWithBlacklist(isCheckTx, []sdk.AccAddress{})
}

// Setup initializes a new SimApp. A Nop logger is set in SimApp.
func SetupWithBlacklist(isCheckTx bool, blacklist []sdk.AccAddress) *SojahubApp {
...
func SetupFromGenesis(isCheckTx bool, genesisTransformer func(*SojahubApp, GenesisState) GenesisState) *SojahubApp {
...
func AddTestAddrs(app *SojahubApp, ctx sdk.Context, accNum int, accAmt sdk.Int) []sdk.AccAddress {
	return addTestAddrs(app, ctx, accNum, accAmt, CreateRandomAccounts)
}

func addTestAddrs(app *SojahubApp, ctx sdk.Context, accNum int, accAmt sdk.Int, strategy GenerateAccountStrategy) []sdk.AccAddress {
